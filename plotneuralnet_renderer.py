...
\\pic[shift={{({x:.2f},{y:.2f},0)}}] at (0,0,0)
    ...
    def _escape_latex(self, text: str) -> str:
        text = self._to_ascii_pdflatex(str(text))
        replacements = {
            "\\": r"\textbackslash{}",
            "&": r"\&",
            "%": r"\%",
    ...
    def _to_ascii_pdflatex(self, text: str) -> str:
        # pdflatex in this project is not configured for Unicode input.
        # Convert common Cyrillic/typographic chars to ASCII-safe text.
        cyr_map = {
